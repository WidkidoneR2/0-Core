...
"""INT-227 G1 census + a platform error-swallow LINT.
    ...
    python3 zero/rust-tools/novashell/generate-platform-census.py          # write the doc
    python3 zero/rust-tools/novashell/generate-platform-census.py --check  # G6, exit 1 on drift
...
def main():
    ...
    doc.append("`python3 zero/rust-tools/novashell/generate-platform-census.py`.")
    doc.append("")
