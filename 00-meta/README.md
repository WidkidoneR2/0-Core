...
- **`core` v2.0.0** — single orchestrator binary with 28+ native Rust domains
...
- **93 complete intents** — every architectural decision documented
...
*Auto-generated by faelight-docs v1.0.0 — last sync: 2026-03-22 16:11*
