...
---
**`core` v3.0.0** — a single Rust binary with 51+ native domains:
| Domain | Capability |
|--------|-----------|
...
| v11.1.0 | The Forest Speaks | 167 complete intents milestone |
...
*Auto-generated by faelight-docs v2.0.0 — last sync: 2026-04-10 00:37*
