...
**`core` v2.0.0** — a single Rust binary with 42+ native domains:
...
139 complete intents. 7 planned. Every one a chapter in the forest's history.
...
*Auto-generated by faelight-docs v2.0.0 — last sync: 2026-03-31 22:06*
