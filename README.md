...
**`core` v2.0.0** — a single Rust binary with 39+ native domains:
...
70 custom Rust tools, each understood and intentional:
...
116 complete intents. 7 planned. Every one a chapter in the forest's history.
...
*Auto-generated by faelight-docs v1.0.0 — last sync: 2026-03-30 22:46*
