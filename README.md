...
| v11.1.0 | The First Word | 187 complete intents milestone |
...
core values list
```
187 complete intents. 17 planned. Every one a chapter in the forest's history.
---
```bash
...
*Auto-generated by faelight-docs v2.0.0 — last sync: 2026-04-19 00:16*
