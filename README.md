...
**`core` v2.0.0** — a single Rust binary with 34+ native domains:
...
95 complete intents. Every one of them is a chapter in the forest's history.
...
*Auto-generated by faelight-docs v1.0.0 — last sync: 2026-03-25 21:37*
