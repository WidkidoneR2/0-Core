...
|---------|-------|-----------|
| v13.0.0 | **Intelligence in the Shell** | fsh v2.x parallel+natural language+sessions, Core v22 Friday active, 8 intents |
| v12.0.0 | **The Forest Speaks Human** | Terminal rebuilt, 11 human words, 3 TUIs, Friday planning layer, 25 intents |
...
| v11.1.0 | The First Word | 220 complete intents milestone |
...
core values list
```
220 complete intents. 14 planned. Every one a chapter in the forest's history.
---
```bash
...
*Auto-generated by faelight-docs v2.0.0 — last sync: 2026-05-03 20:32*
