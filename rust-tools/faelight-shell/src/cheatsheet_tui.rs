...
fn curate_builtin_desc(name: &str) -> Option<&'static str> {
    Some(match name {
        ...
        "bump-versions" => "Bump version numbers across the forest",
        "chart" => "Render a chart",
        "checkpoints-table" => "Checkpoints in table form",
        "clean" => "Resolve an ambiguous command via learned preference",
        "commits" => "Show recent commits",
        "compare" => "Compare two items",
        "count" => "Count items",
        "dashboard" => "Open the forest dashboard",
        "debug" => "Show debug information",
        "decisions-table" => "Decisions in table form",
        "dev" => "Run tests (nextest) for a tool or all",
        "domains" => "List engine domains",
        "dry-run" => "Show what a command would do without executing",
        "errors" => "Show error history",
        "events-table" => "Events in table form",
        "failures" => "Show command failure history",
        "fd" => "Find files by pattern",
        "files" => "List files",
        "forest-stats" => "Forest statistics",
        "friday-patterns" => "Show Friday's learned patterns",
        "from" => "Range start bound",
        "fstat" => "File statistics",
        "git-branches" => "Git insight: branches",
        "git-churn" => "Git insight: file churn",
        "git-commits" => "Git insight: commit activity",
        "git-files" => "Git insight: tracked files",
        "histogram" => "Render a histogram",
        "history-replay" => "Replay commands from history",
        "history-search" => "Search command history",
        "history-table" => "History in table form",
        "hpattern" => "Detect patterns in command history",
        "hstats" => "Command history statistics",
        "last_command" => "Recall the last command",
        "last_error" => "Recall the last error",
        "let" => "Bind a variable (scripting)",
        "memory" => "Friday memory interface",
        "observe" => "Record an observation to Friday",
        ...
        "ps" => "List processes",
        "pv" => "Smart, type-aware file preview",
        "select" => "Run a SQL query against state.db",
        "since" => "Filter by time (since X)",
        "snap-diff" => "Diff two snapshots",
        "source" => "Source/execute a script file",
        "time" => "Time a command's execution",
        "timeline" => "Show activity timeline",
        "to" => "Range end bound",
        "tools-table" => "Tools in table form",
