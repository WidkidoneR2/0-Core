...
The forest's tool ecosystem: 38 active tools (plus 1 retired), each a purpose-built Rust program.

**Generated:** 2026-06-28 by `faelight-docs readme-generate`
...
| Tool | Version | Description |
|------|---------|-------------|
| [`faelight-release`](./faelight-release/) | 1.0.0 | 🌲 Intelligent release and generation manager — the forest publishes itself |
...
| Tool | Version | Description |
|------|---------|-------------|
| [`faelight-shell`](./faelight-shell/) | 2.5.0 | Forest-native structured shell environment — beyond NixOS |
...
| Tool | Version | Description |
|------|---------|-------------|
| [`get-version`](./get-version/) | 4.0.0 | Get system version from VERSION file |
