...
fn cmd_list(filter: Option<&str>) {
    ...
    // Always count complete intents for accurate summary
    if !show_complete && !show_all {
        let complete_dir = intent_dir.join("complete");
        if complete_dir.exists() {
            complete_count = fs::read_dir(&complete_dir)
                .into_iter()
                .flatten()
                .flatten()
                .filter(|e| {
    ...
    println!("{}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{}", GRAY, NC);
    println!(
        "Active: {}  |  {}Complete: {}{}  |  {}Planned: {}{}  |  {}In Progress: {}{}",
        total_count,
        GREEN,
        complete_count,
        NC,
